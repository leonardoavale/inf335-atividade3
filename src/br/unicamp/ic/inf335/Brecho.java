...
public class Brecho {
	...
	public static void main(String[] args) {
		...
		System.out.println("Codigo = " + produtos.get(i).getCodigo() + " Nome = " +
		produtos.get(i).getNome() + " Valor = " + produtos.get(i).getValor());
		}
		...
		// Imprime produtos ordenados
		 ...
		 for (int i=0; i<produtos.size(); i++) { System.out.println("Codigo = " +
		 produtos.get(i).getCodigo() + " Nome = " + produtos.get(i).getNome() +
